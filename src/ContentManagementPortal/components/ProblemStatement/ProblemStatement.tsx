...
import {
   problemStatement,
   problemStatementPro
} from '../../../CommonModule/i18n/strings.json'
import { toast } from 'react-toastify'
import 'react-toastify/dist/ReactToastify.css'
import ProblemStatementQuestionDetailsModel from '../../models/ProblemStatementQuestionDetailsModel'
...
type ProblemStatementProps = {
   statement: ProblemStatementQuestionDetailsModel
   getUserSignInAPIError: string | null
   saveUserData: (postData, onSuccess, onFailure) => void
}

@observer
class ProblemStatement extends React.Component<ProblemStatementProps> {
   ...
   onChangeEditor = newValue => {
      ...
      this.errorMessage =
         this.problemDescription.length > 1 ? '' : this.errorMessage
   }
         ...
         <ProblemStatementView>
            <ProblemStatementMode>
               ...
               <CreatePreviewProblemStatement>
                  {selectedMode === 'HTML' ? (
                     <iframe
                        srcDoc={this.problemDescription}
                        src={problemStatementPro.iframeSrc}
                     >
                        <p>{problemStatementPro.HTMLPreviewMessage}</p>
                     </iframe>
                  ) : (
