...
class CreateCodingQuestions extends React.Component {
   ...
   renderCodingQuestionUI = observer(({}) => {
      ...
      if (contentManagementStore.codingQuestionDetails) {
         statement =
            contentManagementStore.codingQuestionDetails.problemStatement
         roughSolutions =
            contentManagementStore.codingQuestionDetails.roughSolution
         prefilledCode =
            contentManagementStore.codingQuestionDetails.prefilledCode
         solutionApproach =
            contentManagementStore.codingQuestionDetails.solutionApproach
         cleanSolution =
            contentManagementStore.codingQuestionDetails.cleanSolution
      }
      const {
         saveUserData,
         ...
         <CreateCodingQuestionsView>
            ...
            {selectedTask === 'Problem Statement' ? (
               <ProblemStatement
                  statement={statement}
                  selectedTask={selectedTask}
                  postUserDataAPIError={postUserDataAPIError}
                  changeSelectedTask={changeSelectedTask}
               ...
               <RoughSolution
                  ...
                  selectedTask={selectedTask}
                  saveRoughSolutionList={saveRoughSolutionList}
                  changeSelectedTask={changeSelectedTask}
               />
   ...
   render() {
      const { contentManagementStore } = this.props
      const {
         getCodingQuestionDetailsAPIError,
         getCodingQuestionDetailsAPIStatus
      } = contentManagementStore
      return (
