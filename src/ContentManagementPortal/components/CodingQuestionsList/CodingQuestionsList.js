    ...
    render() {
        ...
        return (
            <CodingQuestionsListView>
                ...
                {(selectedTask === "Problem Statement")?<ProblemStatement/>:
                (selectedTask === "Rough Solution")?<RoughSolution/>:
                (selectedTask === "Test Cases")?<TestCases/>:
                (selectedTask === "Prefilled Code")?<PrefilledCode/>:''}
            </CodingQuestionsListView>
        );
    }
}
