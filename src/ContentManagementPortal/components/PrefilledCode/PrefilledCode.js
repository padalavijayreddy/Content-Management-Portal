...
class PrefilledCode extends React.Component {
   ...
   addCodeEditor = () => {
      ...
      this.PrefilledCodeList.set(
         editorObject.delete_id,
         new PrefilledCodeModel(editorObject)
      )
   }
   ...
   onSuccess = () => {
      ...
      toast.success(
         'If you want to add another Prefilled Code, please click on the Add button'
      )
      this.PrefilledCodeList = new Map()
   }
