...
import {
   ...
   Header,
   SortingFunctions
} from './RenderCodingQuestionsListStyle'
...
import SortView from '../../../../CommonModule/components/SortView'
         ...
         <RenderCodingQuestions>
            <SortingFunctions>
               ...
               <ExportSort>
                  ...
                  >
                     <option value={RenderCodingQuestionsStrings.StatusValue}>
                        {RenderCodingQuestionsStrings.Status}
                     </option>
                     <option
                        value={RenderCodingQuestionsStrings.InProcessValue}
                     >
                        {RenderCodingQuestionsStrings.InProcess}
                     </option>
                     <option
                        value={
                           RenderCodingQuestionsStrings.YettobeReveiwedValue
                        }
                     >
                        {RenderCodingQuestionsStrings.YettobeReveiwed}
                     </option>
                     <option
                        value={RenderCodingQuestionsStrings.CompletedValue}
                     >
                        {RenderCodingQuestionsStrings.Completed}
                     </option>
                  </Select>
                  <Sort>
                     <SortView />
            ...
            <SelectAll>
               <SelectAllDiv>
                  <input
                     ...
                     onClick={this.IsClickedSelectAll}
                     type='checkbox'
                  />
                  <SelectAllStyle>
                     {RenderCodingQuestionsStrings.SelectAll}
                  </SelectAllStyle>
               </SelectAllDiv>
               <DeleteDiv>
                  <EditButton disabled={!this.isChecked} state={this.isChecked}>
                     <MdEdit />
                     Edit
                  </EditButton>
                  <DeleteButton
            ...
            <QuestionRow>
               <Questions>
                  ...
                  <img
                     src={RenderCodingQuestionsStrings.questionArrowImageURL}
                     alt={RenderCodingQuestionsStrings.questionArrowImageAlt}
                  />
               </Questions>
               <div className='flex justify-around w-full'>
                  ...
                  <Header>
                     {RenderCodingQuestionsStrings.SolutionApproach}
                  </Header>
            ...
            <Footer>
               ...
               <AddButton>
                  <div>
                     Page {currentPagePosition} of {totalCountOfPages}
                  </div>
               </AddButton>
               {/*<ReactPaginate
               ...
               <div class='flex justify-end items-center'>
                  <button
                     ...
                     onClick={currentPagePositionDecrementor}
                     class='flex items-center justify-center bg-black text-white w-8 h-8 mr-2 focus:outline-none'
                  >
                     <svg
                        stroke='currentColor'
                        fill='currentColor'
                  ...
                  <p class='border border-black w-8 h-8 flex justify-center items-center'>
                     {currentPagePosition}
                  </p>
                  <div class='mx-2'> / </div>
                  <p>{totalCountOfPages}</p>
                  <button
                     disabled={currentPagePosition === totalCountOfPages}
                     onClick={currentPagePositionIncrementor}
                     class='flex items-center justify-center bg-black text-white w-8 h-8 ml-2 focus:outline-none '
                  >
                     <svg
                        stroke='currentColor'
                        fill='currentColor'
