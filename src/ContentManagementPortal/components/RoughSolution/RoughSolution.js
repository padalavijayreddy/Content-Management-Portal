...
class RoughSolution extends React.Component {
   ...
   addCodeEditor = () => {
      ...
      this.roughSolutionList.set(
         editorObject.delete_id,
         new RoughSolutionModel(editorObject)
      )
   }
   ...
   onSuccess = () => {
      ...
      toast.success(
         'If you want to add another Rough Solution, please click on the Add button'
      )
      this.roughSolutionList = new Map()
   }
