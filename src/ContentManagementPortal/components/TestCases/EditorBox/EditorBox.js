    ...
    render() {
        ...
        return (
            <TestCasesComponent>
                ...
                <OutputEditor onChangeOutputContent={onChangeOutputContent} id={eachTestcase.id} />
                <Header>SCORE</Header>
                <Checkbox type="text" onChange={this.onChangeScoreValue} value={this.score} placeholder='66'/>
                <IsHiddenCheck>
