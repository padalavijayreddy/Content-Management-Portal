...
class TestCases extends React.Component {
   ...
   get renderTestCases() {
      ...
      let testData = testCasesListOfArray.find(
         eachTestcase => eachTestcase.isActive
      )
   ...
   addButton = () => {
      ...
      testCasesListOfArray.forEach(
         eachTestcase => (eachTestcase.isActive = false)
      )
      this.testCasesList.set(
         editorObject.testcases_id,
         new TestCasesModel(editorObject)
      )
   }
   ...
   makeActiveItem = id => {
      ...
      console.log(
         'Item Active',
         [...this.testCasesList.values()].find(
            eachTestcase => eachTestcase.isActive
         )
      )
   }
   ...
   render() {
      return (
         <TestCasesComponent>
            ...
            <TestCasesView>{this.renderTestCases}</TestCasesView>
         </TestCasesComponent>
      )
   }
}
