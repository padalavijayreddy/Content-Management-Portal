...
import { HintView, SaveButtonField, HintsComponent, HintsIdList, Add } from './HintsStyle';
...
class Hints extends React.Component {
    ...
    renderHints = () => {
        ...
        return hintsListOfArray.map(eachHint => {
            ...
            if (eachHint.isActive) { return <EditorBox 
                key={eachHint} 
                id={eachHint.id}
                eachHint={eachHint} 
    ...
    renderHintsIds = () => {
        ...
        return hintsListOfArray.map((eachHint, index) => {
            return <IdButton key={eachHint} id={eachHint.id} index={index} eachHint={eachHint} makeActiveItem={makeActiveItem} deleteId={deleteId}/>;
        });
    }
