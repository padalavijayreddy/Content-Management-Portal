         ...
         <HeaderView>
            <FileNameBox>
               <FileName
                  ...
                  placeholder={roughSolution.fileNameIncludeExtension}
               />
            </FileNameBox>
            <SelectFields>
               <LanguageSelect
                  data-testid={cleanSolution.Headertestid}
                  id={id}
                  value={this.selectLanguage}
                  onChange={this.onChangeLanguageValue}
               >
               ...
               <DeleteIcon
                  onClick={onRemoveEditorBox}
                  id={id}
                  src={roughSolution.deleteIconURL}
                  alt={roughSolution.deleteIconAlt}
               ></DeleteIcon>
               <EditorIcon
                  src={roughSolution.editorIconURL}
                  alt={roughSolution.editorIconAlt}
               ></EditorIcon>
            </SelectFields>
         </HeaderView>
      )
