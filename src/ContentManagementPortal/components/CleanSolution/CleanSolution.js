...
class CleanSolution extends React.Component {
   ...
   addCodeEditor = () => {
      ...
      this.cleanSolutionList.set(
         editorObject.delete_id,
         new CleanSolutionModel(editorObject)
      )
   }
   ...
   onSuccess = () => {
      ...
      toast.success(
         'If you want to add another Clean solution, please click on the Add button'
      )
      this.cleanSolutionList = new Map()
   }
