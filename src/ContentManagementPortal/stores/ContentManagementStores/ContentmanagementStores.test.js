...
describe("ContentManagementStores Tests", () => {
    ...
    it("should test contentManagementAPI data fetching state", () => {
        ...
        expect(contentManagementStores.getCodingQuestionsListAPIStatus).toBe(API_FETCHING);
    });
    ...
    it("should test contentManagementAPI success state", async() => {
        ...
        expect(contentManagementStores.getCodingQuestionsListAPIStatus).toBe(API_SUCCESS);
    });
    ...
    it("should test initialising ContentManagement store", () => {
        expect(contentManagementStores.postSolutionDataAPIStatus).toBe(API_INITIAL);
    ...
    it("should test contentManagementAPI data fetching state", () => {
        ...
        contentManagementStores.saveRoughSolutionList(postObject, onSuccess, onFailure);
        expect(contentManagementStores.postSolutionDataAPIStatus).toBe(API_FETCHING);
        expect(onSuccess).not.toBeCalled();
        expect(onFailure).not.toBeCalled();
    });
    ...
    it("should test contentManagementAPI success state", async() => {
        ...
        await contentManagementStores.saveRoughSolutionList(postObject, onSuccess, onFailure);
        expect(contentManagementStores.postSolutionDataAPIStatus).toBe(API_SUCCESS);
        expect(onSuccess).toBeCalled();
    });
    ...
    it("should test initialising ContentManagement store", () => {
        expect(contentManagementStores.postPrefilledDataAPIStatus).toBe(API_INITIAL);
    ...
    it("should test contentManagementAPI data fetching state", () => {
        ...
        contentManagementStores.savePreFilledList(postObject, onSuccess, onFailure);
        expect(contentManagementStores.postPrefilledDataAPIStatus).toBe(API_FETCHING);
        expect(onSuccess).not.toBeCalled();
        expect(onFailure).not.toBeCalled();
    });
    ...
    it("should test contentManagementAPI success state", async() => {
        ...
        await contentManagementStores.savePreFilledList(postObject, onSuccess, onFailure);
        expect(contentManagementStores.postPrefilledDataAPIStatus).toBe(API_SUCCESS);
        expect(onSuccess).toBeCalled();
    });
